...
sidebar: sidebar 
keywords:  
summary: 'La mise à niveau vers Unified Manager 9.8 n"est possible qu"avec des instances de 9.6 ou 9.7.' 
---
...
[role="lead"]
La mise à niveau vers Unified Manager 9.8 n'est possible qu'avec des instances de 9.6 ou 9.7.
