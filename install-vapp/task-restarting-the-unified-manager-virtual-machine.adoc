...
https://developer.broadcom.com/powercli/latest/vmware.vimautomation.core/commands/restart-vmguest["Références des applets de commande VMware vSphere PowerCLI : restart-VMGuest"^]
