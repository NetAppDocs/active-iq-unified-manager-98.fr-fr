...
* MySQL Community Edition version 8.0.21 (à partir du référentiel MySQL). Assurez-vous que vous avez supprimé toute version précédemment installée de MySQL 5.7. Le programme d'installation d'Unified Manager a été limité à la prise en charge de MySQL Community Edition 8.0.21, en raison d'un problème d'interopérabilité. Vous devez *pas* mettre à niveau MySQL vers une version supérieure à 8.0.21.
