...
| `grep p7zip` 
|===
. Si la version installée de MySQL est antérieure à MySQL 8.0.21 Community Edition, entrez la commande suivante pour la désinstaller :``rpm -e <mysql_package_name>``
+
